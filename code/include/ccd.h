 ...
 */
_ccd_export void ccdFirstDirDefault(const void *o1, const void *o2, ccd_vec3_t *dir);
 ...
 */
_ccd_export int ccdGJKIntersect(const void *obj1, const void *obj2, const ccd_t *ccd);
 ...
 */
_ccd_export int ccdGJKSeparate(const void *obj1, const void *obj2, const ccd_t *ccd, ccd_vec3_t *sep);
 ...
 * If memory allocation fails -2 is returned.
 */
_ccd_export int ccdGJKPenetration(const void *obj1, const void *obj2, const ccd_t *ccd, ccd_real_t *depth, ccd_vec3_t *dir,
                                  ccd_vec3_t *pos);

/**
 * Returns true if two given objects intersect - MPR algorithm is used.
 */
_ccd_export int ccdMPRIntersect(const void *obj1, const void *obj2, const ccd_t *ccd);
 ...
 */
_ccd_export int ccdMPRPenetration(const void *obj1, const void *obj2, const ccd_t *ccd, ccd_real_t *depth, ccd_vec3_t *dir,
                                  ccd_vec3_t *pos);
