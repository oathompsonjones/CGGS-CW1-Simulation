 ...
 */
_ccd_export ccd_real_t ccdVec3PointSegmentDist2(const ccd_vec3_t *P, const ccd_vec3_t *a, const ccd_vec3_t *b, ccd_vec3_t *witness);
 ...
 */
_ccd_export ccd_real_t ccdVec3PointTriDist2(const ccd_vec3_t *P, const ccd_vec3_t *a, const ccd_vec3_t *b, const ccd_vec3_t *c,
                                            ccd_vec3_t *witness);
